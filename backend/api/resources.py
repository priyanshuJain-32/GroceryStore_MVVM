...
# from .. import db
# from ..models.models import Category, Product, Users
# from datetime import datetime
# from ..decorators.token_deco import token_required
# from ..decorators.admin_deco import admin_required, staff_required
...
# #------------------------ GET All Category ---------------------------------------------
# @resource.route("/get_all_category", methods=['GET'])
# @token_required
...
# #------------------------ GET Category ---------------------------------------------
# @resource.route("/get_category/<int:category_id>", methods=['GET'])
# @token_required
...
# #------------------------ POST Category ---------------------------------------------
# @resource.route("/post_category", methods=['POST'])
# @token_required
# @admin_required
# def post_category():
...
# #------------------------ PUT Category ---------------------------------------------
# @resource.route("/put_category/<int:category_id>", methods=['PUT'])
# @token_required
# @admin_required
...
# #------------------------ DELETE Category ---------------------------------------------
# @resource.route("/delete_category/<int:category_id>", methods=['DELETE'])
# @token_required
# @admin_required
...
# #------------------------ GET All Product ---------------------------------------------
# @resource.route("/get_all_product", methods=['GET'])
# @token_required
...
# #------------------------ GET Product ---------------------------------------------
# @resource.route("/get_product/<int:product_id>", methods=['GET'])
# @token_required
...
# #------------------------ POST Product ---------------------------------------------
# @resource.route("/post_product", methods=['POST'])
# @token_required
# @staff_required
# def post_product():
...
# #------------------------ PUT Product ---------------------------------------------
# @resource.route("/put_product/<int:product_id>", methods=['PUT'])
# @token_required
# @staff_required
...
# #------------------------ DELETE Product ---------------------------------------------
# @resource.route("/delete_product/<int:product_id>", methods=['DELETE'])
# @token_required
# @admin_required
